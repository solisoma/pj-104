        ...
        <div className="relative flex justify-center">
          <div className="flex flex-col gap-8 px-4 py-[5rem] w-full md:px-10 lg:w-[72%]">
            ...
            <p className="text-xl text-[#7B8EA4]">
              Noble Elite Trades has been sharing financial freedom with traders
      ...
      <div className="flex justify-center">
        <div className="flex flex-col gap-8 px-4 pt-[5rem] w-full md:px-10 md:pt-[6rem] lg:w-[72%]">
          ...
          <div className="flex flex-col gap-4 mb-[3rem] md:justify-between md:flex-row">
            ...
            <div className="flex-1">
              <BoxThree
                desc="We seek to manage risk in order to capitalize on opportunities and improve our performance. Disciplined risk estimation and management are deeply integrated components of the investment process across each one of our strategies. We believe a well-constructed portfolio upfront will outperform in good markets and protect our client's capital in difficult markets. For this reason, Noble elite trade has spent over a quarter of a century establishing risk management as a core discipline. This approach begins with a dedicated governance group that oversees risk management. An emphasis on liquid markets, proprietary risk models and a diversified funding structure seeks to further strengthen our approach.<br/><br/>At Noble elite trade, we advance sustainable economic growth and financial opportunity. Drawing on over eight years of experience working with the world's leading businesses, entrepreneurs, and institutions, we mobilize our people, culture, technologies, and ideas to advance the success of our clients, broaden individual prosperity, and accelerate economic progress for all. Our purpose comes to life through our four core values: Client Service, Excellence, Integrity, and Partnership."
